...
export default function About() {
  const testimonials = [
    {
      quote:
        "S ThinkHome máme konečně partnera, který zvládá i noční incidenty. SLA drží do puntíku a pravidelné reporty nás vždy připraví na audit.",
      name: "Samuel Palubinský",
      title: "COO • FinPro účetnictví",
    },
    {
      quote:
        "Díky automatizovanému onboarding procesu máme připravené účty pro každého pracovníka během pár minut. Bezpečnost i dostupnost konečně odpovídá realitě na stavbách.",
      name: "Ondrej Janík",
      title: "Technický ředitel • StavInovace",
    },
    {
      quote:
        "ThinkHome dodal kompletní řešení chytré domácnosti, které funguje stabilně a je snadno spravovatelné. Oceňuji rychlé reakce na každou změnu i transparentní komunikaci.",
    ...
    <div className="space-y-24 pb-16">
        ...
        <div className="text-center space-y-4">
          ...
          <BlurFade delay={0.2}>
            <p className="text-lg text-muted-foreground">
              Od návrhu po nonstop provoz. Vyberte si jednotlivé služby nebo kompletní balíček. Vždy
              víte, co a proč implementujeme.
            </p>
          </BlurFade>
        </div>
      ...
      <div id="contact" className="max-w-4xl mx-auto px-8 space-y-8 scroll-mt-24">
        <div className="text-center space-y-4">
          ...
          <BlurFade>
            <p className="text-lg text-muted-foreground">
              Ozvěte se, ozveme se do 24 hodin. Probereme vaše potřeby, ukážeme relevantní case
              studies a navrhneme první kroky. Bez závazku.
            </p>
          </BlurFade>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <BlurFade>
                <a
                  href="https://github.com/thinkhome"
                  target="_blank"
